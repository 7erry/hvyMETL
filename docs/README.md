...
| [25-copilot-security.md](25-copilot-security.md) | Copilot LLM Phase 0 guardrails — message validation, rate limits, audit logs | `src/copilot/copilotRequestGuard.ts`, `src/server/copilotRateLimit.ts` |
...
| [18-sql-dialects.md](18-sql-dialects.md) | Twenty-two supported SQL dialects — SQLite live adapter vs DDL paste import | `src/dialects.ts`, `src/utilities/ddlParser.ts` |
...
| *(external)* | `knowledge/mongo-vs-sql-decipherist.md` | Curated summary of [The Decipherist — MongoDB vs SQL (2026)](https://thedecipherist.com/articles/mongo_vs_sql/) | JSON pipeline, aggregation-first reads, SQL→Mongo quick reference for Query Translator / Copilot |
