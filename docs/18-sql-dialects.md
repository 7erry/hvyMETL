...
hvyMETL supports **twenty-two SQL dialects** for schema import. They fall into two
capability tiers:
...
2. **DDL paste** — **all twenty-two dialects**: paste `CREATE TABLE` scripts; a shared
...
flowchart TB
    ...
    subgraph ddl [DDL paste — all 22 dialects]
