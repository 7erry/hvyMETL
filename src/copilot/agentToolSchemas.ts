...
import { COPILOT_MONGO_ATLAS_SEARCH_INDEX_OPENAI_TOOLS } from './mongoAtlasSearchToolSchemas.js';
import { COPILOT_MONGO_CLASSIC_INDEX_OPENAI_TOOLS } from './mongoClassicIndexToolSchemas.js';
...
export const COPILOT_OPENAI_TOOLS = [
  ...
  ...COPILOT_MONGO_ATLAS_SEARCH_INDEX_OPENAI_TOOLS,
  ...COPILOT_MONGO_CLASSIC_INDEX_OPENAI_TOOLS,
];
